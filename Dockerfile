...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -o APT::Immediate-Configure=0 -yqq cmake gcc-arm-none-eabi jq curl ca-certificates gnupg && apt-get clean
...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -yqq nodejs && apt-get clean
